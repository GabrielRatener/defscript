...
export const patterns = [
  ...
  },
  {
    ...
    test(context) {
      ...
      return (
        context.input.length > context.start + 1 &&
        !whitespaceRegex.test(context.input[context.start + 1])
      )
    }
  },
  {
  ...
  // operators
  {
    ...
    test(context) {
      return (
        context.input.length > context.start + context.match.length &&
        context.input[context.start + context.match.length] === ' '
      )
    }
  },
  {
