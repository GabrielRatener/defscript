...
export const postprocessors = [
  ...
  (() => {
    ...
    const piping = ['pipe-left', 'pipe-right']

    const remove = {
      before: new Set(['nl', ']', '}', ',', 'pipes', ...piping]),
      after: new Set(['[', '{', ',', ...piping])
    };
  ...
  (() => {
    ...
    const before = new Set(['else', 'catch', 'finally', 'outdent', '*', '**', 'right-return']);
    const after = new Set(['indent', '=', '*', '**', 'left-return']);
